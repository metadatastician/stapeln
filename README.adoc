...
// Seven further badges are WANTED and awaiting restoration — WCAG 2.3 AAA, OWASP,
// SOC 3, ISO 27001, CIAQ, Green Hosting and OpenSSF Best Practices — plus a CRG
// grade badge blocked by a
// broken `just` recipe. Each is listed in docs/BADGES.adoc with exactly what is
// needed to put it back. They were removed on 2026-08-07 only because nothing in
// this repository verified them; they are not abandoned.
