...
// Badges removed 2026-08-07 because nothing in this repository verified them:
// WCAG 2.3 AAA, OWASP Compliant, SOC 3, ISO 27001, CIAQ. Each was a static
// shields.io image; the three compliance badges linked to a private org settings
// page rather than an attestation. Re-add any of them alongside a dated, public
// audit artefact — see DEBT.md D-2.
