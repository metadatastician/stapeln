...
`LICENSE.txt`. See link:LICENSING.md[LICENSING.md]. It also says "README.adoc | This file",
which is true of the template, not of this document.

Retained as a reference for RSR structure. See link:DEBT.md[DEBT.md] D-7.
====
