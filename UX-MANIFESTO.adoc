...
* Deployment succeeds → Green checkmark {plus} sound
* Deployment fails → Red X {plus} specific error {plus} fix
...
Do: 3 options {plus} "Advanced" button

[[x-cryptic-abbreviations]]
...
Do: Just do it {plus} undo button
