...
// Replace stapeln, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= stapeln — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining stapeln for
...
* Upstream: https://github.com/hyperpolymath/stapeln/issues
