...
DATA & DOCS
  ...
  Documentation                    ########..  80%     STATUS.adoc truth-aligned; TOPOLOGY.adoc updated 2026-03-23
...
* `container-stack/svalinn` {plus} `container-stack/vordr` are the *runtime plane* for container lifecycle operations.
